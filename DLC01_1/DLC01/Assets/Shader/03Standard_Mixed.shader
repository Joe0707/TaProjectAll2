Shader "URP/03Standard_Mixed"
{
    Properties
    {
        ...
        _MetallicGlossMap("Mask(R=Metal,G=AO,A=Roughness)",2D) = "white"{}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                half Occlusion = lerp(1.0,specGloss.g,_Occlusion);
                half Roughness = max(1.0 - specGloss.a * _Smoothness,0.001f);
                ...
                half3 DirectLighting = half3(0,0,0);
                {
                    ...
                    half3 DirectLighting_MainLight = half3(0,0,0);
                    {
                        ...
                        half3 LightColor = light.color * light.distanceAttenuation;//这里如果是SUBTRACTIVE模式 light.distanceAttenuation值等于0 目的是这个模式不提供直接光照
